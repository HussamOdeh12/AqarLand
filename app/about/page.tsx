            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="pt-6 border-t border-[#E2DED6] dark:border-[#2C2F33] grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div className="border border-[#E2DED6] dark:border-[#2C2F33] p-4 bg-[#EFECE6]/40 dark:bg-[#2C2F33]/20">
                  <span className="font-semibold uppercase tracking-wider text-[#C85A32] block mb-1">
                  ...
                  <p className="font-arabic text-[#2C2F33]/80 dark:text-[#E2DED6]/80 mt-1">
                ...
                <div className="border border-[#E2DED6] dark:border-[#2C2F33] p-4 bg-[#EFECE6]/40 dark:bg-[#2C2F33]/20">
                  ...
                  <p className="text-[#2C2F33]/80 dark:text-[#E2DED6]/80 mt-1 font-mono">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {COMPANY_DETAILS.values.map((val, idx) => (
              ...
              >
                <span className="font-mono text-xs font-bold text-[#C85A32] tracking-wider block">
                  0{idx + 1}
                </span>
