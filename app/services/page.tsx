          ...
          <div className="flex items-center gap-6 min-w-max">
            {STITCH_SERVICES.map((s) => (
              <a
                ...
                className="text-xs font-mono tracking-wider text-[#2C2F33] dark:text-[#E2DED6] hover:text-[#C85A32] dark:hover:text-[#C85A32] transition-colors flex items-center gap-2"
              >
                <span className="text-[#C85A32] font-bold">{s.number}</span>
                ...
                >
                  ...
                  <div className={`lg:col-span-7 space-y-6 ${!isEven ? 'lg:col-start-6' : ''}`}>
                    <div className="flex items-center gap-4">
                      <span className="font-mono text-lg font-bold text-[#C85A32] tracking-wider">
                        {service.number}
                      </span>
                      <div className="h-px flex-1 max-w-[80px] bg-[#E2DED6] dark:bg-[#2C2F33]" />
                      <span className="text-xs font-mono uppercase tracking-widest text-[#628E9D]">
                    ...
                    <div className="pt-6 flex flex-wrap items-center gap-4">
                      <Link
                        ...
                        className="inline-flex items-center gap-3 bg-[#C85A32] px-6 py-3 text-xs font-semibold uppercase tracking-widest text-white hover:bg-[#B84D28] transition-colors"
                      >
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-2 border border-[#E2DED6] dark:border-[#2C2F33] px-5 py-3 text-xs font-semibold text-[#181A1B] dark:text-[#F7F5F0] hover:border-[#C85A32] transition-colors"
                        dir="ltr"
                      >
